...
void DomElement::jsStringLiteral(WStringStream& out, std::string_view s, char delimiter)
{
...
void DomElement::jsStringLiteral(EscapeOStream& out, std::string_view s, char delimiter)
{
  out << delimiter;
