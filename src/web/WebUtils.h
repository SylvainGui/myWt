...
extern std::string append(std::string_view s, char c);
...
extern WT_API std::string urlEncode(std::string_view url,
...
extern long WT_API stol(const std::string_view v);
extern unsigned long WT_API stoul(const std::string_view v);
extern long long WT_API stoll(const std::string_view v);
extern unsigned long long WT_API stoull(const std::string_view v);
extern int WT_API stoi(const std::string_view v);
