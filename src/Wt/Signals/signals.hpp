  ...
  namespace Signals
  {
        ...
        struct SignalLink : public SignalLinkBase
        {
          ...
          void decref()
          {
            ...
            #pragma GCC diagnostic ignored "-Wfree-nonheap-object"
              delete this; //-Wfree-nonheap-object false positive
            else
              assert(ref_count > 0);
          }
    ...
    namespace Impl
    {
      ...
      struct ConnectHelper
      {
        ...
        {
          return signal.connect([target, method](Args... a)
                                { (target->*method)(a...); },
                                target);
        }
      };
      ...
      struct ConnectHelper<0, Args...>
      {
        ...
        {
          return signal.connect([target, method](Args...)
                                { (target->*method)(); },
                                target);
        }
      };
      ...
      struct ConnectHelper<1, Args...>
      {
        ...
        {
          return signal.connect([target, method](B1 b1, An...)
                                { (target->*method)(b1); },
                                target);
        }
      };
      ...
      struct ConnectHelper<2, Args...>
      {
        ...
        {
          return signal.connect([target, method](B1 b1, B2 b2, An...)
                                { (target->*method)(b1, b2); },
                                target);
        }
      };
      ...
      struct ConnectHelper<3, Args...>
      {
        ...
        {
          return signal.connect([target, method](B1 b1, B2 b2, B3 b3, An...)
      ...
      connection connectFunction(Signal<Args...> &signal,
                                 typename std::enable_if<!std::is_bind_expression<F>::value, F &&>::type function,
                                 const Core::observable *target)
      {
        return ConnectHelper<function_traits<F>::argCount, Args...>::connect(signal, target, Signals::Impl::toFunction(std::move(function)));
      }
